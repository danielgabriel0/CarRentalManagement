...
namespace CarRentalManagement.Server.Controllers
{
    ...
    public class ColoursController : ControllerBase
    {
        ...
        // GET: api/Colours
        [HttpGet]
        // public async Task<ActionResult<IEnumerable<Colour>>> GetColour_1()
        public async Task<IActionResult> GetColours()
        {
            ////if (_context.Colour_1 == null)
            //{
            //    return NotFound();
            //}
            //return await _context.Colour_1.ToListAsync();
        ...
        public async Task<IActionResult> GetColour(int id)
        {
            ...
            //    return NotFound();
            //}
            //  var Colour = await _context.Colour_1.FindAsync(id);
        ...
        public async Task<ActionResult<Colour>> PostColour(Colour Colour)
        {
            //if (_context.Colour_1 == null)
            //{
            //    return Problem("Entity set 'ApplicationDbContext.Colour_1'  is null.");
            //}
            //_context.Colour_1.Add(Colour);
            //await _context.SaveChangesAsync();
        ...
        public async Task<IActionResult> DeleteColour(int id)
        {
            ...
            //_context.Colour_1.Remove(Colour);
            //await _context.SaveChangesAsync();
        ...
        {
            //return (_context.Colour_1?.Any(e => e.Id == id)).GetValueOrDefault();
            var Colour = await _unitOfWork.Colours.Get(q => q.Id == id);
            return Colour != null;
        }
    }
